defmodule OverviewBuilderTest do
  ...
  test "should aggregate skills by area in single dataset" do
    ...
    assert OverviewBuilder.build(content,[]) == [%{capability: "DevOps", data: [0,0,5,0,3,0]}]
  end
